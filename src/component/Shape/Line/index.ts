...
import { Board, GraphicElement, ItemMenubar, StyleMenubar } from '../../index';
import { ButtonInfo } from '../../Toolbar/ItemMenubar';
import { ComponentRepository, TransformManager } from '../../../service';
import {BOARD_ID, COLOR, COMPONENT_TYPE, MENU_BAR} from '../../../service/constant';
...
class Line extends Shape {
    public static type: string = COMPONENT_TYPE.Line;
    public type: string = Line.type;
    _points: Array<Point> = [];
    _line: GraphicElement = null;
    _arrow = null;
    ...
    get line(): GraphicElement {
        return this._line;
    }

    set line(value: GraphicElement) {
        this._line = value;
    }
