...
import { CustomElement, GraphicElement } from '../../index';
import { ComponentRepository, TransformManager, HistoryManager } from '../../../service';
...
class GText extends Shape {
    static type: string = COMPONENT_TYPE.GText;
    public type: string = GText.type;
    board = null;
    styleMenubar = null;
    _foreignObj = null;
    _textBox = null;
